            ...
            <div class="row gy-4">
                ...
                <div>
                    <div class="visi-misi-content">
                        ...
                        <form action="{{ route('Ppdb') }}" method="GET" class="search-form">
    <input type="text" name="search" value="{{ request()->search }}" placeholder="Cari berdasarkan Nama Dan NISN" class="search-input"/>
    <select name="status" class="search-input" style="max-width: 150px; height:40px;">
...
@if ($siswa->isEmpty())
    ...
    @endsection
    <style>
        /* Pastikan teks di dalam tabel terlihat */
.table tbody td {
