...
<body>
    ...
    <div class="visi-misi-wrapper">
        ...
        <span class="pipe">|</span> STRUKTUR ORGANISASI
        </div>
    </div>
    ...
    <div class="content-wrapper">
        ...
        <div class="main-content">
            <div class="row gy-4">
                <!-- News Card 1 -->
               <div style="text-align:center; color:#a42728;">
                <h1>STRUKTUR ORGANISASI SEKOLAH</h1>
                <h5>SEKOLAH DASAR NEGERI PERADUAN WARAS</h5>
               </div>
<img src="{{asset('images/StrukturSekolah.png')}}" alt="">
