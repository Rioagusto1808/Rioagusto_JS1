...
<body>
    ...
    <div class="visi-misi-wrapper">
        ...
        <span class="pipe">|</span> VISI MISI
        </div>
    </div>
...
<div class="visi-misi-content">
    <h1>VISI</h1>
    <p>MEWUJUDKAN PROSES PEMBELAJARAN YANG EFEKTIF DAN EFISIEN</p>
    <p>MEWUJUDKAN MEWUJUDKAN KELULUSAN YANG BERAKHLAK MULIA, CERDAS, TERAMPIL, SEHAT JASMANI DAN ROHANI, KREATIF DAN KOMPETITIF</p>
    <p>MEWUJUDKAN PROGRAM WAJIB BELAJAR SEMBILAN TAHUN</p>
    <p>MEWUJUDKAN PENDIDIKAN YANG MEMILIKI KOMPETENSI DAN KREATIVITAS YANG BERSYARATKAN STANDAR PENDIDIKAN NASIONAL</p>
    <p>MEWUDUKAN PRASARANA DAN SARANA PENDIDIKAN YANG MENDUKUNG PROSES PEMBELAJARAN SISWA YANG BERSTANDAR NASIONAL</p>
    <p>MEWUDUKAN KEMAMPUAN SEKOLAH YANG EFEKTIF DAN EFISIEN</p>
    <p>MEWUDUKAN STANDAR PENILAIAN SESUAI STANDAR KOMPETENSI KELULUSAN</p>

    <h1>MISI</h1>
    <p>TERWUJUDNYA SEKOLAH BERWAWASAN IMTAQ, IPTEK, SENI BUDAYA. MENGHASILKAN PESERTA DIDIK YANG CERDAS SEHAT JASMANI DAN ROHANI, DISPLIN DAN SOPAN SANTUN DALAM BERSIKAP</p>
</div>
