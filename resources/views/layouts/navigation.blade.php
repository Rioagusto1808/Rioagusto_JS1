...
<body>
    ...
    >
        <div class="container-fluid">
            ...
            <h1 class="navbar-brand" style="font-size: 20px; color:white; margin-top:10px;">SD N Peraduan Waras</h1>
            </div>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" style="border-radius: 10px">
                            ...
                            <li>
                                <a class="dropdown-item" href="/mata_pelajaran">Mata Pelajaran</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="/jadwal">Tahun Ajaran & Mata Pelajaran</a>
                            </li>
                        </ul>
                    </li>
                </ul>
